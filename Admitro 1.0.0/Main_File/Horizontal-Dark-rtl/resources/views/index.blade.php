								...
								<div class="card">
									...
									<div class="card-body">
										...
										<div class="text-center mt-2">
											<span class="ml-4"><span class="dot-label bg-primary"></span>Total Sales</span>
											<span class="mr-4"><span class="dot-label bg-secondary"></span>Total Units Sold</span>
										</div>
									</div>
								</div>
							</div>
											...
											<table class="table table-vcenter text-nowrap mb-0 table-striped table-bordered border-top">
												...
												<tbody>
													<tr>
														...
														<td><i class="fa fa-check ml-1 text-success"></i> In Stock</td>
													</tr>
													<tr>
